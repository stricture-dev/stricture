...
No. It's automatically installed as a dependency of the ESLint plugin.
...
All official presets are bundled with the plugin - no additional installation needed!
