...
| Preset | Best For | Complexity | Learning Curve | Key Benefit |
|--------|----------|------------|----------------|-------------|
| **Hexagonal** | Complex domains, DDD | Medium-High | Medium | Domain isolation |
| **Layered** | Traditional apps | Low-Medium | Low | Familiar pattern |
| **Clean** | Enterprise apps | Medium-High | Medium | Strict dependencies |
| **Modular** | Large teams | Medium | Low-Medium | Module encapsulation |
| **Next.js** | React SSR apps | Low | Low | Framework-specific |
| **NestJS** | API backends | Low-Medium | Low | Framework-specific |
