...
import CleanDiagram from '../../../components/CleanDiagram.tsx';
...
Explore the clean architecture's concentric circles at different levels of detail:

<CleanDiagram client:load />
