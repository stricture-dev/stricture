...
**All architecture presets are bundled** - no need to install them separately!
...
<Tabs>
  ...
  <TabItem label="With Other Plugins">
    ```js title="eslint.config.js"
...
**No `.stricture/config.json` needed!** The preset is loaded automatically from the plugin.
