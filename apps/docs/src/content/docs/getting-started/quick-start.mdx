...
Install Stricture core, ESLint plugin, and the hexagonal preset:
...
<Tabs>
  ...
  <TabItem label="pnpm">
    ```bash
    pnpm add -D @stricture/core @stricture/eslint-plugin @stricture/hexagonal
    ```
  </TabItem>
  <TabItem label="yarn">
    ```bash
    yarn add -D @stricture/core @stricture/eslint-plugin @stricture/hexagonal
    ```
  </TabItem>
</Tabs>
